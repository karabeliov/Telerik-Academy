...
taskName = "Planar coordinates";

function Main(bufferElement) {
    // Input
    var x1 = 6, // Change value to TEST
        y1 = 9,
        x2 = 15,
        y2 = 19;
    // Solution   
    ...
    // Output
    WriteLine("Calculate Points Distance: " + calculatePointsDistance(x1, y1, x2, y2));
    WriteLine("Can form triangle? " + canFormTriangle());
}