    ...
    function auth($http, $q, identity, authorization, baseServiceUrl) {
        ...
        return {
            ...
            login: function (user) {
                ...
                $http.post('http://spa.bgcoder.com/token', 'username=' + user.username + '&password=' + user.password + '&grant_type=password', { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } })
